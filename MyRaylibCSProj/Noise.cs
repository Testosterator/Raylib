...
namespace MyRaylibCSProj
{
    public static class Noise
    {
        ...
        42,223,183,170,213,119,248,152,2,44,154,163,70,
        221,153,101,155,167,43,
        172,9,129,22,39,253,19,98,108,110,79,113,224,
        232,178,185,112,104,218,246,97,228,251,34,
        242,193,238,210,144,12,191,
        ...
        private static int[] p; // permutacja x2
        ...
        public static double Perlin(double x, double y, double z = 0)
        {
            ...
            return (res + 1.0) / 2.0; // zmapuj na zakres [0,1]
        }
    }
}
